		...
		<div class="menu">
			<div id="wrap_menu">
				<ul class="float">
                    ...
                    <li><a class="aktif" href="<?php echo site_url('logged/C_rumahsinggah');?>">Rumah Singgah</a></li>
...
<!-- Batas sidebar-->
     <div class="content">
        <div id="wrap_header_content">
                            ...
                            <div id="header_modal">
                             ...
                             <form method="post" action="<?php echo site_url('logged/C_rumahsinggah/post/')?>">
                                <div id="wrap_content_modal">
                                    Kota/Daerah <br><input type="text" name="lokasi" class="input_text"><br>
                                    ...
                                    <input type="text" name="kontak" class="input_kontak"><br>
        	...
        	<form id="form_search2" method="get" action="<?php echo site_url('logged/C_rumahsinggah/cari')?>">
				<input class="search2" name="lokasi" type="text" placeholder="Cari Rumah Singgah..." required>
        ...
        <div class="output_post">
                        ...
                        <nav>
                            <ul>
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="<?php echo site_url('logged/C_rumahsinggah/hapus/'.$tampil->id)?>"><img src="<?php echo base_url('assets/images/delete.png')?>" height="11" width="12">Hapus</a>
                                             <a href="<?php echo site_url('logged/C_rumahsinggah/edit/'.$tampil->id)?>"><img src="<?php echo base_url('assets/images/edit.png')?>" height="11" width="12">Update</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
            ...
            <img id="img_icon" src="<?php echo base_url ('assets/images/hom.png'); ?>" > <?php echo $tampil->lokasi;?>            
            <div id="txt_post"><img id="img_icon" src="<?php echo base_url ('assets/images/call.png'); ?>" > <?php echo $tampil->kategori_kontak?> , <?php echo $tampil->kontak?></div><br>
